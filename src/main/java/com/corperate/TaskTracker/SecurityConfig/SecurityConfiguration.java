    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http
                ...
                .authorizeHttpRequests(request->request.
                        ...
                        .requestMatchers("/TaskManagement/myTaskAssigned").hasRole("EMPLOYEE")
                        .requestMatchers("/TaskManagement/UpdateStatus/**").hasRole("EMPLOYEE")
                        .requestMatchers("/TaskManagement/TaskHistoryById/**").hasRole("EMPLOYEE")
